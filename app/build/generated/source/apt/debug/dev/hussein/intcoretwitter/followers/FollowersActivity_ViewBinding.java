...
public class FollowersActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public FollowersActivity_ViewBinding(FollowersActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public FollowersActivity_ViewBinding(FollowersActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FollowersActivity target = this.target;
