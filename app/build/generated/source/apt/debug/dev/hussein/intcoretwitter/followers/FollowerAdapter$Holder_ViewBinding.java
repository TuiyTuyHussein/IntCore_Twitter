...
public class FollowerAdapter$Holder_ViewBinding implements Unbinder {
  private FollowersAdapter.Holder target;

  @UiThread
  public FollowerAdapter$Holder_ViewBinding(FollowersAdapter.Holder target, View source) {
    this.target = target;
